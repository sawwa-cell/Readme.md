...
## Удаление веток
Чтобы удалить ветку, надо находясь в **ветке мастер** нажать команду **git branch -d <название ветки> (можно ввести через пробел, все ненужные ветки) и они удалятся.
